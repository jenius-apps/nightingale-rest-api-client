...
namespace Nightingale.ViewModels
{
    public class RequestBodyViewModel : ViewModelBase
    {
        ...
        public RequestBodyViewModel(IFilePicker filePicker)
        {
            _filepicker = filePicker ?? throw new ArgumentNullException(nameof(filePicker), "IFilePicker can't be null");
        }
        ...
        public async void FormDataSelectFilesClicked(object sender, FormData item)
        {
            ...
            Analytics.TrackEvent("Form data select files clicked", new Dictionary<string, string>
            {
