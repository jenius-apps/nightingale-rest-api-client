...
public class CollectionViewModel : ObservableBase
{
    ...
    public async void RunAllRequests()
    {
        ...
        {
            success = false;
            _telemetry.TrackEvent("Collection run cancelled");
        }
        catch (Exception e)
        {
            success = false;
            _telemetry.TrackEvent("Collection run failed", new Dictionary<string, string>()
            {
                { "message", e.Message }
            });
        ...
        if (success)
        {
            _telemetry.TrackEvent("Collection run button pressed", new Dictionary<string, string>
            {
