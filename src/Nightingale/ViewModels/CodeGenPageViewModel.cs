...
public class CodeGenPageViewModel : ViewModelBase
{
        ...
        ITelemetry telemetry)
    {
        ...
        _restSharpGenerator = restSharpGenerator;
    ...
    public int SelectedLangIndex
    {
        ...
        set
        {
            ...
            _telemetry.TrackEvent("Code generator language changed", new Dictionary<string, string>() { { "Lang", ((LanguageIndex)value).ToString() } });
            Rerun();
        }
    }
