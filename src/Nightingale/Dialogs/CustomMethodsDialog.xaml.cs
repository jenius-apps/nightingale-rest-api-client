...
public sealed partial class CustomMethodsDialog : ContentDialog
{
        ...
        RoutedEventArgs e)
    {
            ...
            && f.DataContext is string method)
        {
            ...
            App.Services.GetRequiredService<ITelemetry>().TrackEvent(Telemetry.CustomMethodRemoved, new Dictionary<string, string>
            {
                { "value", method }
            });
        }
        ...
        ContentDialogButtonClickEventArgs args)
    {
        ...
        App.Services.GetRequiredService<ITelemetry>().TrackEvent(Telemetry.CustomMethodReset);
        args.Cancel = true;
    }
    ...
    private void AddNew()
    {
            ...
            && !Methods.Contains(NewMethodBox.Text.Trim()))
        {
            ...
            App.Services.GetRequiredService<ITelemetry>().TrackEvent(Telemetry.CustomMethodAdded, new Dictionary<string, string>
            {
