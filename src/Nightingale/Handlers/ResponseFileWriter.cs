...
namespace Nightingale.Handlers
{
    public class ResponseFileWriter : IResponseFileWriter
    {
        ...
        private readonly Dictionary<string, KeyValuePair<string, string>> _supportedFileTypes = new Dictionary<string, KeyValuePair<string, string>>
        {
        ...
        public async Task WriteFileAsync(IWorkspaceResponse response)
        {
            ...
            try
            {
                ...
                Analytics.TrackEvent(Telemetry.SaveBodyClicked, new Dictionary<string, string>
                {
            ...
            {
                Analytics.TrackEvent(Telemetry.SaveBodyError, new Dictionary<string, string>
                {
